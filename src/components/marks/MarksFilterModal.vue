    ...
    <div v-if="isOpen" class="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 backdrop-blur-sm !-mt-6 p-4 animate-in fade-in duration-200">
        <div class="bg-card w-full max-w-md rounded-lg shadow-lg border flex flex-col animate-in zoom-in-95 duration-200">
            ...
            <div class="p-4 border-b flex items-center justify-between">
                <h3 class="text-lg font-bold">Filter Marks</h3>
            ...
            <div class="p-6 space-y-6">
                ...
                <!-- Synced Status -->
                <div class="space-y-2">
                    <label class="text-sm font-medium">Synced Status</label>
                    <div class="flex items-center gap-4">
                        ...
                        <label class="flex items-center gap-2 cursor-pointer">
                            ...
                            <span class="text-sm">Unsynced Only</span>
                        </label>
                    </div>
                </div>
                ...
                <!-- Date From -->
                <div class="space-y-2">
                    <label for="DateFromFilter" class="text-sm font-medium">Added From</label>
                    <div class="relative">
