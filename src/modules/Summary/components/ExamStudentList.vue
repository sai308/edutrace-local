...
const { students: examStudents, isLoading, loadExamData, meets, tasks, groupsMap } = useSummaryData();
...
async function removeMark(student) {
    ...
    try {
        ...
        const assessment = await summaryService.getFinalAssessmentByStudent(student.id, props.assessmentType);
