...
import { useSummaryData } from '@/modules/Summary/composables/useSummaryData';
...
<template>
    <div class="space-y-4">
        <div class="flex items-center justify-between">
            <h3 class="text-lg font-semibold">{{ $t('documents.title') }}</h3>
            <p class="text-sm text-muted-foreground">{{ $t('documents.description') }}</p>
        </div>

        <div class="mb-4">
            <div class="relative">
                <Search class="absolute left-2 top-2.5 h-4 w-4 text-muted-foreground" />
                <input v-model="searchQuery" type="text" :placeholder="$t('documents.searchPlaceholder')"
                    ...
                    <thead class="bg-muted/50 text-muted-foreground font-medium border-b">
                        <tr>
                            ...
                            <th class="p-3 text-center min-w-[100px] cursor-pointer hover:text-foreground transition-colors"
                                ...
                                <div class="flex items-center justify-center gap-1">
                                    {{ $t('documents.table.assessmentType') }}
                            ...
                            <th class="p-3 text-center min-w-[100px] cursor-pointer hover:text-foreground transition-colors"
                                ...
                                <div class="flex items-center justify-center gap-1">
                                    {{ $t('documents.table.documentedAt') }}
                            ...
                            <td class="p-3 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <button @click="toggleSynced(assessment)" class="p-1.5 rounded-md transition-colors"
                                        ...
                                        :title="assessment.syncedAt ? $t('documents.tooltips.markAsUnsynced') : $t('documents.tooltips.markAsSynced')">
                            ...
                            <td class="p-3 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <button @click="toggleDocumented(assessment)"
                                        ...
                                        :title="assessment.documentedAt ? $t('documents.tooltips.markAsUndocumented') : $t('documents.tooltips.markAsDocumented')">
